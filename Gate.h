...
class Gate: public Node{
    ...
    vector<Node*> MCMC_RJ(int N, bool doRJ, int RJ_every, int L, mat* accept_RJ,vec y, mat X, vec mu_beta, mat Sigma_beta, double a, double b, mat Omega, vec mu_gamma1, mat Sigma_gamma1, double sigma_epsilon, vector<Node*> z_final);//updates parameters followed by allocations N times with RJ 
    vector<Node*> MCMC_RJ(int N, bool doRJ, int RJ_every, int L,vec y, mat X, vec mu_beta, mat Sigma_beta, double a, double b, mat Omega, vec mu_gamma1, mat Sigma_gamma1, double sigma_epsilon, vector<Node*> z_final);//updates parameters followed by allocations N times with RJ 
    ...
    vector<Node*> split_at_root(vec y, mat X, Expert* ExpertToSplit, Expert* ExpertToAdd, vector<Node*> z_assign,  vec mu_beta, mat Sigma_beta, vec mu_gamma1, mat Sigma_gamma1, double sigma_epsilon, double a, double b, mat Omega);// double mu_jump, double sigma_jump, vec mu_beta, mat Sigma_beta, vec* x_record, vec* gamma_record){
    vector<Node*> split(vec y, mat X, Expert* ExpertToSplit, Expert* ExpertToAdd, Gate* GateToAdd, vector<Node*> z_assign,  vec mu_beta, mat Sigma_beta, vec mu_gamma1, mat Sigma_gamma1, double sigma_epsilon, double a, double b, mat Omega);// double mu_jump, double sigma_jump, vec mu_beta, mat Sigma_beta, vec* x_record, vec* gamma_record){
    ...
    vector<Node*> merge(vec y, mat X, int* accept, Gate* GateToMerge, vector<Node*> z_assign, vec mu_beta, mat Sigma_beta, double a, double b, mat Omega);
